...
// import getDfa from "./dfa"
// const position = { x: 0, y: 0 };
// const res = getDfa("(0+10*)");
// const dfa=res[1];
// let initialElements=[];
...
//           id: `${i}`,
//           data: { label: "q"+count },
//           style: { border: '1px solid blue', width: 45, height: 40 ,paddingTop: 0,fontSize:15,borderRadius:20 },
//           position : position
//         };
//         if(el.final===true)
//         {
//            node1.style={ border: '1px solid green',paddingTop: 2, width: 45, height: 40,color:'blue',borderRadius:20,fontSize:8};
